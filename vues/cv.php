                ...
                <div class="col-12 col-xs12 col-sm-12 col-md-12  offset-xl-3 col-xl-6 col-lg-12 mt-4 mb-5">
                  ...
                  <div class="shadow-lg p-1 mb-5 rounded border2 border-light2" style="background-color: #555b61; margin-left: 1.5%">
                    ...
                    <div class="jumbotronCV text-center">
                      ...
                      <p class="djbchalk text-uppercase titrecv" style="color:white">téléchargement</p>

                      <p class="djbchalk " style="color:white">Cliquez sur le lien afin de pouvoir télécharger mon cv !</p>
                      <hr class="my-4">
                      <a class="btn btn-light btn-lg sketch" href="Public/file/cv.pdf" target="_blank" role="button">MON CV</a>
                    </div>
