<div id="nav" class="container-fluid sticky-top"style="padding:0;background-color:white; font-weight: 700; font-size: 15.5px; font-family: Arial, Helvetica, sans-serif; border-bottom: 4px solid #555b61">
        <nav class="navbar navbar-expand-lg navbar-light middlesection" style="background-color:white;">
          ...
          <a class="navbar-brand" href="index.php"><img src="/Public/img/NM.png" alt="nm"/></a>
