      ...
      <div class="row">
          <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 text-center">
              ...
              <div class="card shadow-lg p-2 mb-4 bg-projet rounded" style="width: 100%;">
                  ...
                  <div class="card-body" style="background-color: #b7bdbf">
                      <h5 class="caviardreams" style="">Les enfants d'arc en ciel</h5>
            ...
            <div class="card shadow-lg p-2 mb-4 bg-projet rounded" style="width: 100%;">
              <div id="carouselprojet" class="carousel slide" data-ride="carousel">
                <ol class="carousel-indicators">
                  ...
                  <li data-target="#carouselprojet" data-slide-to="4"></li>
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                      <a href="https://www.lesenfantsdarcenciel.ovh/" class="btn btn-dark btn-lg btn-block sketch" target="_blank" >ACCEDER AU SITE</a>
                    </div>
                  </div>
                  ...
                  <div class="carousel-item">
                    <img class="d-block w-100" src="Public/img/carousel/lecarrefour2.jpg" alt="Le carrefour2">
                  </div>
                </div>
          ...
          <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 text-center">
              ...
              <div class="card shadow-lg p-2 mb-4 bg-projet rounded" style="width: 100%;">
                  ...
                  <div class="card-body" style="background-color: #b7bdbf">
                      <h5 class="caviardreams" style="">Restaurant Le Carrefour</h5>
